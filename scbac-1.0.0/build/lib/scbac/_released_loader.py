...
from .models.transformer import GeneAttentionAgePredictor
from .models.clm import NeuralCumulativeLink
...
class UnifiedAgePredictor:
    ...
    model_root : str, optional
        Released ``scBrainAgeClock_models_file/`` directory containing
        CLM_*, ElasticNet_*, Transf_* and benchmarking_model/.
    ...
    def __init__(
        ...
        # The public Zenodo archive stores all stage directories directly
        # under scBrainAgeClock_models_file/.
        self.scbac_model_dir = self.model_root
